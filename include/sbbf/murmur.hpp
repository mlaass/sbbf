#ifndef SBBF_MURMUR_HPP
#define SBBF_MURMUR_HPP
// Adopted from https://sites.google.com/site/murmurhash/
...
inline std::vector<uint32_t> murmur(std::string s, uint32_t seed = 12345) {
  uint32_t hash[5];
